    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><img src="img/logo1.png"  width="20%" height="100%" style="border-radius:10%">&nbsp;Info</a> 
            </div>
	...
	<li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="Students-Grievance-Management-System-main\index.php">Complaint</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="student-registration-system-with-login-system-main\index.php">Student Info</a>
                            </li>
                        </ul>
                    </li>
                    <li>
