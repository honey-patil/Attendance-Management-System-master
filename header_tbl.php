            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">EEE<span class="fa arrow"></span></a>
                            ...
                            <li>
                            <a href="#">COMP<span class="fa arrow"></span></a>
                           <ul class="nav nav-third-level">
                                    <li>
                                        <a href="#">First Year<span class="fa arrow"</span></a>
                                        <ul class="nav nav-forth-level">
                      ...
                      <a href="#">CIVIL<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="#">First Year<span class="fa arrow"></span></a>
                                        <ul class="nav nav-forth-level">
                            ...
                            <li>
                        <li>
                        <a href="#">MECH<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="#">First Year<span class="fa arrow"></span></a>
                                        <ul class="nav nav-forth-level">
